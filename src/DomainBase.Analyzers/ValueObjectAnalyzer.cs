...
public sealed class ValueObjectAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor MissingCustomHashCodeError = new(
        ...
        messageFormat: "The property '{0}' has [CustomEquality] but is missing the required static method 'GetHashCode_{1}' with signature: private static void GetHashCode_{1}(in T value, ref HashCode hashCode)",
        category: "Usage",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true);
